...
surface_water |> 
  select(name, datetime, pressure_psi, temperature_f, depth_ft_qc = depth_adjust04) |> 
  write_csv(here::here("data", "surface_water", "cleaned_surface_water_data_042025.csv"))
